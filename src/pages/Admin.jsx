...
const Admin = () => {
  ...
  // Sintaxis corregida para useForm
  const {
    register,
    handleSubmit,
    reset,
      ...
      <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            <button
              type="submit"
              className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-md shadow transition-colors cursor-pointer"
            >
            ...
            {editingId && (
              <button
                ...
                className="px-4 py-2 bg-gray-500 hover:bg-gray-600 text-white font-medium rounded-md transition-colors cursor-pointer"
              >
                Cancelar Edición
              </button>
            )}
              ...
              <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                ...
                <td className="p-4 text-center whitespace-nowrap">
                  <button
                    ...
                    className="px-3 py-1.5 bg-amber-500 hover:bg-amber-600 text-white text-xs font-medium rounded mr-2 transition-colors cursor-pointer"
                  >
                    Editar
                  </button>
                  <button
